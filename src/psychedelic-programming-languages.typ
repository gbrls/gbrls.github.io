...
I don't know why but I started reading _Land of `Lisp`_ and it really did fuck me up.
...
Common `Lisp` is a psychedelic programming language, and _Land of `Lisp`_ really
did show that.


![image](https://www.`lisp`erati.com/different.jpg)
