...
#link("http://www-formal.stanford.edu/jmc/recursive.html")[paper] where he defined the
...
operations, it really shows its elegance and power. There's a more #link("http://www.paulgraham.com/rootsoflisp.html")[approachable
  paper] by Paul Graham in which he
...
#img("static/cons-cell-0.png")

> _Example 1: List_

#img("static/cons-cell-1.gif")
...
#link("https://en.wikipedia.org/wiki/Homoiconicity")[homoiconicity]. They can be in the form of atoms or other s-expressions enclosed by
